...
use super::{SwitchRouteService, notify_callbacks};
use crate::{Listener, route::SwitchRoute};
...
impl<SR> PartialEq for WebRouteService<SR>
where
...
impl<SR> Default for WebRouteService<SR>
where
    SR: SwitchRoute + 'static,
{
    fn default() -> Self {
